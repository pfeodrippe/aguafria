...
(az/defn pit-state-tread-probe [:array 4 :f32]
...
(az/defn fixture-language-plan! :u8
  "Explicit manual fixture submission. Never attribute these words to AI." [[index :usize] [revision :u64] [expires :u64] [text [:slice-const :u8]]]
...
(az/defn language-control-probe LanguageControlResult
...
(az/defn captured-grid-recovery-controls-probe [:array 2 driver/Control]
  ...
  (az/init [(az/index sim/vehicle-controls 0) (az/field (sim/recovery-view 0) control)] [:array 2 driver/Control]))
...
(az/defn controlled-grid-probe RacePhysicsResult
...
(az/defn classification-probe ClassificationResult
...
(az/defn finished-car-clearance-probe [:array 3 :f32]
  ...
  (let [racer (sim/racer-pointer 0)]
    ...
    (sim/step-many! 360)
    (az/init [(* 1000.0 (az/field (sim/racer-view 0) speed))
...
(az/defn lapped-wreck-observation-probe :u8
