...
(az/defconst model-items [:array 26 :u8]
  (az/init [82 105 103 105 100 0 88 80 66 68 0 67 111 110 116 105 110 117 117 109 32 70 69 77 0 0] [:array 26 :u8]))
...
(az/defn export-end! :i32 [[file [:optional [:* :anyopaque]]]]
  ...
  (let [run (export-handle file)
    ...
    (let [files (az/init [(az/field run trajectory) (az/field run particles) (az/field run reference)
