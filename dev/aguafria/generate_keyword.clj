...
(defn- write-std-output!
  ...
  (prepare/write-entrypoints! {:kind :std :namespaces (:namespaces catalog)}))
    ...
    (let [catalog (generate-catalog {})
      ...
      (if check?
          ...
          (do
            (binding [*out* *err*]
              ...
              (when-not std-current?
                (println "Zig std catalog is stale:"
                         std-catalog-path))
        ...
        (do
          ...
          (let [{:keys [removed-count namespace-count]}
            ...
            (println "Generated" std-catalog-path "with"
                     ...
                     namespace-count "ignored namespace entry points; removed"
                     removed-count "obsolete generated namespace files.")))))))
