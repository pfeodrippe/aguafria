...
(defmacro defstruct
  ...
  [name fields]
  (let [descriptor {:kind :struct
                    :name name
                    :declaration-key [:struct name]
                    :module (str *ns*)
                    :fields (emitter/parse-typed-bindings fields)
